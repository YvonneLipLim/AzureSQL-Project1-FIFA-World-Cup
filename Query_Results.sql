...
--The results would display teams who didn't enter quarter-final stage.
...
--The results would display top teams total wins for all World Cups.
SELECT *
FROM (
    SELECT 
        Team,
...
--The results would display team with total goals scored for all World Cups.
